...
import '../../create_confirm_screen/create_confirm_screen.dart';
import '../controller/prefefred_location_controller.dart';
...
class _PrefefredLocationScreeenState extends State<PrefefredLocationScreeen> {
  //PrefefredLocationController controller = Get.put(PrefefredLocationController());
  int currentText = 0;
